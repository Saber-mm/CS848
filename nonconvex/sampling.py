...
def noniid(dataset, num_users, user_max_class):
    ...
    """
    if user_max_class == 1:
        num_shards, num_imgs, num_shards_per_user = 20, 3000, 1
    elif user_max_class == 2:
        num_shards, num_imgs, num_shards_per_user = 40, 1500, 2
    elif user_max_class == 5:
        num_shards, num_imgs, num_shards_per_user = 100, 600, 5
    elif user_max_class == 8:
        num_shards, num_imgs, num_shards_per_user = 20*8, 375, 8
    elif user_max_class == 10:
        num_shards, num_imgs, num_shards_per_user = 200, 300, 10
    else:
